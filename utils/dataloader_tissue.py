...
class create_dataset(data.Dataset):
    ...
    Args:
        ...
        seed: seed for reproducing the random result
    '''
    def __init__(self, data_path, trainsize, augmentations, train=True, train_ratio=0.8, rect=False, k=0, k_fold=1, seed=42, num_class=3, cell_size=1, color_ver=-1):
        ...
        try:
            ...
            # self.images = sorted([x for x in f if (x.endswith('.jpg') or x.endswith('.png'))])
        ...
        self.nom = transforms.Normalize([0.7653, 0.5833, 0.6994], [0.1548, 0.1969, 0.1566])#[0.7610, 0.5776, 0.6962], [0.1515, 0.1870, 0.1426]
    ...
    def __getitem__(self, index):
        ...
        name = "/work/wagw1014/OCELOT/tissue/masks/" + name
        name_0 = name + '_0.jpg'
        name_1 = name + '_1.jpg'
        name_2 = name + '_2.jpg'
...
class test_dataset(data.Dataset):
    ...
    def __init__(self, data_path, size, rect):
        ...
        try:
            ...
            self.images = sorted([x for x in f if 'ori_imgs' in x])
            length = len(self.images)
